...
管理层先读：[EXECUTIVE-SUMMARY.md](EXECUTIVE-SUMMARY.md)。团队成员先读：[TEAM-READING-GUIDE.md](TEAM-READING-GUIDE.md)，讨论决策见 [DECISION-BOARD.md](DECISION-BOARD.md)。视觉版架构说明：[architecture-eli5-v2.html](architecture-eli5-v2.html)。工程架构图：[architecture-target.svg](architecture-target.svg)。
