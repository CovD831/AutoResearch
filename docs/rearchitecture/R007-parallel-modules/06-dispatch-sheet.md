...
| L-08 | 不改后端 | 22 个 API 端点已够用；按 `ui-skeleton-first` 先出静态骨架 |
...
第 2 批：L-01 / L-02 / L-03 / L-04 / L-08 / L-09前半  +  L-06（继续 02）
         ← 全部零交集

第 3 批：L-05 剩余  +  L-09 后半（telemetry 依赖 K13）
```
