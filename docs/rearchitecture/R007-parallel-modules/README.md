...
2. **`06-dispatch-sheet.md`** —— **派单表**：现在能同时开哪几条线、各自排他文件与禁区 ★ 要开工时看这张
3. **`00-scope-and-authority.md`** —— 为什么需要它、覆盖什么、权威关系
4. **`02-l1-architecture.md`** —— 9 条线的分层、唯一写入者、不变量、文件面
5. **`04-l2-contracts.md`** —— K1–K16 字段级契约
6. **`03-review-and-steelman.md`** —— 两关审查记录（想了解设计为何是现在这样时读）
