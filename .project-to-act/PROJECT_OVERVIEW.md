...
- 下一里程碑：0.2.0 Literature Pilot，使用一个真实论文 idea 和许可明确 corpus 验收检索/阅读/执行证据
- 当前工作重点：补真实 gold set、RunManifest、进程重启幂等和生产持久化差距；不重做 foundation 骨架
- 主要阻塞：尚无具体论文 idea、目标 venue、许可全文和实验资源边界；不阻塞基础代码维护，阻塞真实 P2/P3/P4 验收
